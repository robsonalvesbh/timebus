...
spl_autoload_register(function ($class_name) {
	...
	if ( file_exists( Constantes::PATH_APP . $class_name . '.php' ) )
		return require_once( Constantes::PATH_APP . $class_name . '.php' );
	else if ( file_exists( Constantes::PATH_CORE . $class_name . '.php' ) )
		return require_once( Constantes::PATH_CORE . $class_name . '.php' );
	else if ( file_exists( Constantes::PATH_DB . $class_name . '.php' ) )
		return require_once( Constantes::PATH_DB.$class_name.'.php' );
	else if ( file_exists( Constantes::PATH_OUTPUT . $class_name . '.php' ) )
		return require_once( Constantes::PATH_OUTPUT . $class_name . '.php' );
	else
